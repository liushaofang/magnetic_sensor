...
#ifndef __MRFI_CC1101_CONCEPT_H__
#define __MRFI_CC1101_CONCEPT_H__

/////////////////////////////////////////////////////////////////////////
/* CC1101 Registers Definitions */

/* configuration registers */
#define IOCFG2      0x00      /*  IOCFG2   - GDO2 output pin configuration  */
#define IOCFG1      0x01      /*  IOCFG1   - GDO1 output pin configuration  */
#define IOCFG0      0x02      /*  IOCFG0   - GDO0 output pin configuration  */
...
#define CHIP_STATE_IDLE 0
#define CHIP_STATE_RX 1
#define CHIP_STATE_TX 2
#define CHIP_STATE_FSTXON 3
#define CHIP_STATE_CALIBRATE 4
#define CHIP_STATE_SETTLING 5
#define CHIP_STATE_RXFIFO_OVERFLOW 6
#define CHIP_STATE_TXFIFO_UNDERFLOW 7
...
#define RSSI_OFFSET     74      //见CC1101数据手册文档Page45


#endif /* MRFI_CC1101_CONCEPT_H_ */
